package com.example.sb.springboot;

import com.example.sb.springboot.domain.Difficulty;
import com.example.sb.springboot.domain.Region;
import com.example.sb.springboot.service.TourPackageService;
import com.example.sb.springboot.service.TourService;
...
public class SpringbootApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		try {
			createTours("C:\\Users\\commo\\OneDrive\\Desktop\\Portfolio\\springboot\\springboot\\ExploreCalifornia.json");
		} catch(Exception e) {
